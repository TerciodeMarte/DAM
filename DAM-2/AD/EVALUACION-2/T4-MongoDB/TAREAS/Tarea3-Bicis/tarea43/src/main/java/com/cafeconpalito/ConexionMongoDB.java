...
/**
 * Clase para gestionar la conexión a la BBDD MongoDB
 *
...
public class ConexionMongoDB {
    ...
    static final String CLUSTER = "@cluster3.8i4aqfo.mongodb.net/?retryWrites=true&w=majority";
    static final String DB = "Tarea3"; // nombre de la base de datos
    ...
    /**
     * Constructor que inicia la colección
     */
    private ConexionMongoDB() {
        ...
        try {
            ...
            e.printStackTrace();
            System.out.println("ERROR CONNECTION MONGO DB");
        }
    }
